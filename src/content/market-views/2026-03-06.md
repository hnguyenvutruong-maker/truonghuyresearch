...
Foreign investors bought VND 19,815.68bn and sold VND 25,970.96bn, producing -6,155.29bn net flow. The source is the daily `GiaoDichNN_VNINDEX` Excel data under `D:\Work\Web\Data`, converted with `python -m markitdown` and reconciled into the local cache.

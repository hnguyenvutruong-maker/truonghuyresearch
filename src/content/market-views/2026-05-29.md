...
avg_daily_liquidity_bn_vnd: 0.73
...
Liquidity is reported at 0.73 bn VND/day, an apparent structural break from last week's 18,070 bn VND/day — flagged for verification. If accurate, the figure represents a ~96% evaporation in turnover and would dominate the flow narrative; if a unit error, the directional read is unchanged but the magnitude is unreliable. Either way, the figure should not be cited as confirmed.

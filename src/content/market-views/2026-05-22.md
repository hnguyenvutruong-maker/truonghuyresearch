...
avg_daily_liquidity_bn_vnd: 0.91
...
**Liquidity**: Average daily turnover registered 0.91 bn VND per the data extract — a dramatic compression from the Q2-2026 baseline of ~18,070 bn VND/day established the prior week. The order-of-magnitude gap is anomalous; we treat the 0.91 figure as a preliminary print pending HoSE primary-feed reconciliation. A genuine liquidity event of this magnitude would itself be a market-structure story; readers should verify before drawing conclusions.

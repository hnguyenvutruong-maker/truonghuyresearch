...
avg_daily_liquidity_bn_vnd: 0.82
...
**Liquidity:** Average daily turnover printed 0.82 bn VND — a reading that is anomalous versus the 18,070 bn VND/day reference from the prior week and most likely reflects a data-feed or unit error. We flag this transparently; liquidity analysis is **data unavailable** for this week and the prior-week reference should anchor positioning reads.

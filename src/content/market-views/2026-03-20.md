...
Foreign investors bought VND 17,688.18bn and sold VND 25,162.78bn, producing -7,474.59bn net flow. The source is the daily `GiaoDichNN_VNINDEX` Excel data under `D:\Work\Web\Data`, converted with `python -m markitdown` and reconciled into the local cache.

...
## Executive Summary
VN-Index closed January with a sharper correction, falling 2.55% to 1,829.04 from a 1,876.81 open. The week traded between 1,793.13 and 1,879.45, meaning the market lost the prior week's support zone and briefly tested below 1,800. Liquidity stayed elevated at an estimated VND 25,476bn/day, so the decline cannot be dismissed as holiday noise.
